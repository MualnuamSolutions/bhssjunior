    ...
    <div class="medium-12 columns">
        <fieldset>
            ...
            <div class="medium-6 columns">
                {{ Form::label('regno', 'Registration Number', ['class' => ($errors->has('regno') ? 'error' : '')]) }}
                {{ Form::text('regno', null, ['class' => $errors->has('regno') ? 'error' : '']) }}
                @if($errors->has('regno'))
                <small class="error">{{ $errors->first('regno') }}</small>
                @endif
