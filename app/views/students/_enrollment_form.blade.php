<ul class="button-group">
   <li><a href="{{ route('students.edit', $students->id) }}" class="button secondary">Profile</a></li>
   <li><a href="{{ route('students.enrollments', $students->id) }}" class="button">Enrollments</a></li>
   <li><a href="{{ route('students.photos', $students->id) }}" class="button secondary">Photos</a></li>
</ul>
