...
<a class="view  button tiny secondary" href="{{ route($route . '.show', $item->id) }}">
   <i class="fi-eye"></i>
   <span class="hide-for-small-only">&nbsp;View</span>
</a>
@endif

@if ( in_array('edit', $actions) )
<a class="edit  button tiny" href="{{ route($route . '.edit', $item->id) }}">
   <i class="fi-page-edit"></i>
   <span class="hide-for-small-only">&nbsp;Edit</span>
</a>
@endif
